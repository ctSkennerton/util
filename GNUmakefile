...
util_tpgms      = bitmat_t bloom_t bndm_t bppack_t msutil_t scan_t sheap_t sock_t subref_t tolog_t udp_t uri_t
...
ifneq ($(OSNAME),DARWIN)
util.c          += $(util)/maccess.c
util_tpgms      += maccess_t
endif
#---------------- PUBLIC VARS:
